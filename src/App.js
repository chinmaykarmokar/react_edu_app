...
import CreateTestAttempt from './components/TestAttempt/CreateTestAttempt/CreateTestAttempt';
            ...
            <HashRouter>
                <div>
                    <Switch>
                        ...
                        <Route path = "/test-attempt-create" component = {CreateTestAttempt}></Route>
                    </Switch>
                </div>
            </HashRouter> 
        )
